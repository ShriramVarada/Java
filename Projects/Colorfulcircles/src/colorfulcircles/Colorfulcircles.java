...
public class Colorfulcircles extends Application {
    ...
    public void start(Stage primaryStage) {
     ...
     new LinearGradient(0f, 0f, 1f, 0f, true, CycleMethod.NO_CYCLE, new 
         Stop[]{
        ...
        circles.setEffect(new BoxBlur(10,10,7));
        ...
        circles.getChildren().forEach((circle) -> {
            timeline.getKeyFrames().addAll(
                    ...
                    ), new KeyFrame(new Duration(1000), // set start position at 0
                            new KeyValue(circle.translateXProperty(), random() * 1200),
